...
import { Clock, Building2, Gamepad2, Layers, CheckCircle2 } from "lucide-react";
...
export const Expertise = () => {
  ...
  return (
    <section id="experience" className="section-padding px-6 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {TOOL_ITEMS.map((tool, i) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={{ ...DEFAULT_TRANSITION, duration: 0.6, delay: shouldReduceMotion ? 0 : i * 0.05 }}
                  className="card-premium p-8 hover:bg-white/[0.05] group"
                >
